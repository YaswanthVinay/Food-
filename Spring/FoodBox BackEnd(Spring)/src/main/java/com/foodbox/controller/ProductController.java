...
public class ProductController {
	...
	public List<Product> getAllProducts() {
		...
		if(prodList.isEmpty()) {
			...
			addProdIfEmpty(new Product(2,"Masala Dosa","Breakfast","Andhra",99,0,0,"yes","./assets/images/Masala Dosa.jpg"));
			addProdIfEmpty(new Product(2,"ColdCoffe","Beverage","India",150,25,0,"yes","./assets/images/ColdCoffe.jpg"));
			addProdIfEmpty(new Product(1,"Naan","Starter","India",125,26,0,"yes","./assets/images/Naan.jpg"));
			addProdIfEmpty(new Product(2,"spring-rolls","Starter","Italian",200,26,0,"yes","./assets/images/spring-rolls.jpg"));
